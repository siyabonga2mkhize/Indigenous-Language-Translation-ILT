...
namespace PhraseBookk.Data.Migrations
{
    ...
    [Migration("20260720110152_AddCustomTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhraseBookk.Models.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhraseBookk.Models.Phrase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhraseBookk.Models.PhraseBookk.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PhraseBookk.Models.PhraseBookk.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PhraseBookk.Models.Favorite", b =>
                {
                    ...
                    b.HasOne("PhraseBookk.Models.PhraseBookk.Models.ApplicationUser", "User")
                        .WithMany("Favorites")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PhraseBookk.Models.Phrase", b =>
                {
                    ...
                    b.HasOne("PhraseBookk.Models.PhraseBookk.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("PhraseBookk.Models.Translation", b =>
                {
                    ...
                    b.HasOne("PhraseBookk.Models.PhraseBookk.Models.ApplicationUser", "SubmittedBy")
                        .WithMany("SubmittedTranslations")
